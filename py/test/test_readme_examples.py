# PhoneNumberValidator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PhoneNumberValidatorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PhoneNumberValidatorSDK(...) and PhoneNumberValidatorSDK.test(...) become
#      PhoneNumberValidatorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "phonenumbervalidator_sdk"
_SDK_CLASS = "PhoneNumberValidatorSDK"
