# PhoneNumberValidator Python SDK



The Python SDK for the PhoneNumberValidator API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.PhoneValidation()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/phone-number-validator-sdk/releases)) or
...
```
py/
├── phonenumbervalidator_sdk.py         -- Main SDK module
