...
from phonenumbervalidator_sdk.utility import register

# Load features
from phonenumbervalidator_sdk.feature.base_feature import PhoneNumberValidatorBaseFeature
from phonenumbervalidator_sdk.features import _has_feature, _make_feature
...
class PhoneNumberValidatorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PhoneNumberValidatorUtility()
    ...
    def get_utility(self):
        return PhoneNumberValidatorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PhoneNumberValidatorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def PhoneValidation(self, data=None) -> "PhoneValidationEntity":
        ...
        from phonenumbervalidator_sdk.entity.phone_validation_entity import PhoneValidationEntity
