...
from phonenumbervalidator_sdk.core.helpers import get_ctx_prop, to_map
...
class PhoneNumberValidatorContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = PhoneNumberValidatorControl()
        ...
        if isinstance(sp, PhoneNumberValidatorSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PhoneNumberValidatorResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PhoneNumberValidatorResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return PhoneNumberValidatorOperation({})
    ...
    def make_error(self, code, msg):
        return PhoneNumberValidatorError(code, msg, self)
