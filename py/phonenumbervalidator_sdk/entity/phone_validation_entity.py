...
from phonenumbervalidator_sdk.phonenumbervalidator_types import (
    PhoneValidation,
...
class PhoneValidationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PhoneValidationEntity(self._client, opts)
    ...
    def data_get(self) -> PhoneValidation:
    ...
    def match_get(self) -> PhoneValidation:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PhoneValidation:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PhoneValidation().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
