...
type Args struct {
	Entity string         `json:"entity" jsonschema:"phone_validation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PhoneNumberValidatorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "phone-number-validator_list",
		Description: "List records from PhoneNumberValidator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "phone-number-validator_load",
		Description: "Load a single record from PhoneNumberValidator. " +
...
func runOp(client *sdk.PhoneNumberValidatorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PhoneNumberValidatorSDK, name string) (sdk.PhoneNumberValidatorEntity, error) {
	switch strings.ToLower(name) {
	case "phone_validation":
		return client.PhoneValidation(nil), nil
