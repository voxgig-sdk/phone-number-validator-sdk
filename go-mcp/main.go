// Command PhoneNumberValidator-mcp is an MCP server exposing the PhoneNumberValidator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PhoneNumberValidator_list  — list records of an entity
//	PhoneNumberValidator_load  — load a single record of an entity
//
