...
function runner.env_override(m)
  local live = runner.getenv("PHONENUMBERVALIDATOR_TEST_LIVE")
  local override = runner.getenv("PHONENUMBERVALIDATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PHONENUMBERVALIDATOR_TEST_EXPLAIN")
