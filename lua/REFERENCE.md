# PhoneNumberValidator Lua SDK Reference

Complete API reference for the PhoneNumberValidator Lua SDK.
...
```lua
local result, err = client:PhoneValidation(nil):load({ id = "phone_validation_id" }, nil)
```
