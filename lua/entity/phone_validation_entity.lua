...
local PhoneValidationEntity = {}
PhoneValidationEntity.__index = PhoneValidationEntity


function PhoneValidationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PhoneValidationEntity)
  self._name = "phone_validation"
  self._client = client
...
function PhoneValidationEntity:get_name()
  return self._name
end


function PhoneValidationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PhoneValidationEntity.new(self._client, opts)
end
...
function PhoneValidationEntity:mark_deleted()
  self._deleted = true
end


function PhoneValidationEntity:deleted()
  return true == self._deleted
end


function PhoneValidationEntity:data_set(args)
  if args ~= nil then
...
function PhoneValidationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PhoneValidationEntity:match_set(args)
  if args ~= nil then
...
function PhoneValidationEntity:match_get()
...
function PhoneValidationEntity:stream(action, args, callopts)
...
---@param reqmatch PhoneValidationLoadMatch
---@param ctrl? table
---@return PhoneValidation
---@return string? err
function PhoneValidationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function PhoneValidationEntity:_run_op(ctx, post_done)
  local utility = self._utility
