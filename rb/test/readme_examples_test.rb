...
#      offline in seeded test mode (PhoneNumberValidatorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "PhoneNumberValidator_sdk.rb")
  SDK_CLASS = "PhoneNumberValidatorSDK"
  ...
  SDK_BASE = "PhoneNumberValidator_sdk"
