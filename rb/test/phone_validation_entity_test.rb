...
class PhoneValidationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set PHONE_NUMBER_VALIDATOR_TEST_PHONE_VALIDATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def phone_validation_basic_setup(extra)
  ...
  entid_env_raw = ENV["PHONE_NUMBER_VALIDATOR_TEST_PHONE_VALIDATION_ENTID"]
