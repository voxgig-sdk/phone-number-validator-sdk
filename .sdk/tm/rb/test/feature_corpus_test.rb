# PhoneNumberValidator SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # PhoneNumberValidatorSDK.new, not PhoneNumberValidatorSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    PhoneNumberValidatorSDK.new(opts)
  end
