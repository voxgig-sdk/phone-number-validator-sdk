...
class PhoneNumberValidatorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PhoneNumberValidatorTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PhoneNumberValidatorTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PhoneNumberValidatorTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
