...
// PhoneNumberValidator SDK proxy feature
...
class PhoneNumberValidatorProxyFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    public function init(PhoneNumberValidatorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PhoneNumberValidatorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
