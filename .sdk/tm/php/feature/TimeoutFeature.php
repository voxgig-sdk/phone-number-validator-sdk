...
// PhoneNumberValidator SDK timeout feature
...
class PhoneNumberValidatorTimeoutFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    private function _with_timeout(PhoneNumberValidatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PhoneNumberValidatorContext $_ctx, float $ms): void
    {
        $client = $this->client;
