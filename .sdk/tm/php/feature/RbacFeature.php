...
// PhoneNumberValidator SDK rbac feature
...
class PhoneNumberValidatorRbacFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    private function _required(PhoneNumberValidatorContext $ctx): ?string
    {
    ...
    private function _reject(PhoneNumberValidatorContext $ctx, string $required): void
    {
    ...
    private function _track(PhoneNumberValidatorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
