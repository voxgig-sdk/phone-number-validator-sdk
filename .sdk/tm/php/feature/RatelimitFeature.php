...
// PhoneNumberValidator SDK ratelimit feature
...
class PhoneNumberValidatorRatelimitFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    private function _acquire(PhoneNumberValidatorContext $ctx): void
    {
    ...
    private function _track(PhoneNumberValidatorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
