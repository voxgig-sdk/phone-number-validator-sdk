...
// PhoneNumberValidator SDK netsim feature
...
class PhoneNumberValidatorNetsimFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    private function _simulate(PhoneNumberValidatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PhoneNumberValidatorContext $ctx, array $applied): void
    {
        $client = $this->client;
