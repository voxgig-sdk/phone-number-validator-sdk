...
// PhoneNumberValidator SDK utility type

class PhoneNumberValidatorUtility
{
    ...
    public static function copy(PhoneNumberValidatorUtility $src): PhoneNumberValidatorUtility
    {
        $u = new PhoneNumberValidatorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
