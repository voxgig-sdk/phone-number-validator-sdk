...
// PhoneNumberValidator SDK pipeline test
//
...
{
    private static function utility(): PhoneNumberValidatorUtility
    {
        return new PhoneNumberValidatorUtility();
    }
    ...
    private static function ctx(array $over = []): PhoneNumberValidatorContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PhoneNumberValidatorContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PhoneNumberValidatorOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PhoneNumberValidatorError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PhoneNumberValidatorOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PhoneNumberValidatorMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PhoneNumberValidatorOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PhoneNumberValidatorMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PhoneNumberValidatorOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PhoneNumberValidatorMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PhoneNumberValidatorSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PhoneNumberValidatorMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new PhoneNumberValidatorResponse([]),
            'result' => new PhoneNumberValidatorResult([]),
        ]);
        [, $err] = PhoneNumberValidatorMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new PhoneNumberValidatorSpec([]),
            'response' => null,
            'result' => new PhoneNumberValidatorResult([]),
        ]);
        [, $err] = PhoneNumberValidatorMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PhoneNumberValidatorSpec(['step' => 's']),
            'response' => new PhoneNumberValidatorResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PhoneNumberValidatorResult([]),
        ]);
        [, $err] = PhoneNumberValidatorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PhoneNumberValidatorSpec(['step' => 's']),
            'response' => new PhoneNumberValidatorResponse(self::resp(200, ['v' => 1])),
            'result' => new PhoneNumberValidatorResult([]),
        ]);
        [, $err] = PhoneNumberValidatorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PhoneNumberValidatorSpec(['step' => 's']),
            'response' => new PhoneNumberValidatorResponse(self::resp(200, ['v' => 2])),
            'result' => new PhoneNumberValidatorResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PhoneNumberValidatorMakeResponse::call($ctx);
    ...
    {
        $preset = new PhoneNumberValidatorResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PhoneNumberValidatorSpec([]),
            'response' => new PhoneNumberValidatorResponse([]),
            'result' => new PhoneNumberValidatorResult([]),
        ...
        [$got, $err] = PhoneNumberValidatorMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PhoneNumberValidatorResult([])]);
        [, $err] = PhoneNumberValidatorMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PhoneNumberValidatorSpec([]), 'result' => null]);
        [, $err] = PhoneNumberValidatorMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PhoneNumberValidatorSpec(['step' => 's']),
            'result' => new PhoneNumberValidatorResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PhoneNumberValidatorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PhoneNumberValidatorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PhoneNumberValidatorSpec(['step' => 's']),
            'result' => new PhoneNumberValidatorResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PhoneNumberValidatorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PhoneNumberValidatorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PhoneNumberValidatorResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PhoneNumberValidatorSpec([]),
            'result' => new PhoneNumberValidatorResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PhoneNumberValidatorMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PhoneNumberValidatorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PhoneNumberValidatorError('boom', 'boom');
        $utility->fetcher = function (PhoneNumberValidatorContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PhoneNumberValidatorSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PhoneNumberValidatorMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PhoneNumberValidatorContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PhoneNumberValidatorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PhoneNumberValidatorResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        PhoneNumberValidatorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PhoneNumberValidatorContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PhoneNumberValidatorSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PhoneNumberValidatorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PhoneNumberValidatorResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PhoneNumberValidatorSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PhoneNumberValidatorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PhoneNumberValidatorMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PhoneNumberValidatorMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PhoneNumberValidatorResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PhoneNumberValidatorDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PhoneNumberValidatorResult(['ok' => false])]);
        $this->expectException(PhoneNumberValidatorError::class);
        PhoneNumberValidatorDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PhoneNumberValidatorResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PhoneNumberValidatorMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        PhoneNumberValidatorMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PhoneNumberValidatorBaseFeature();
        $b = new PhoneNumberValidatorBaseFeature();
        PhoneNumberValidatorFeatureAdd::call($ctx, $a);
        PhoneNumberValidatorFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PhoneNumberValidatorBaseFeature
    {
        $f = new PhoneNumberValidatorBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PhoneNumberValidatorFeatureAdd::call($ctx, self::named_feature('a'));
        PhoneNumberValidatorFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        PhoneNumberValidatorFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        PhoneNumberValidatorFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        PhoneNumberValidatorFeatureAdd::call($ctx, $replace);
        ...
        PhoneNumberValidatorFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PhoneNumberValidatorContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PhoneNumberValidatorSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PhoneNumberValidatorPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        PhoneNumberValidatorPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PhoneNumberValidatorResponse(['headers' => null]),
            'result' => new PhoneNumberValidatorResult([]),
        ]);
        PhoneNumberValidatorResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        PhoneNumberValidatorResultBody::call($ctx);
