...
// PhoneNumberValidator SDK utility: fetcher

class PhoneNumberValidatorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PhoneNumberValidatorSDK/1.0)';
    ...
    public static function call(PhoneNumberValidatorContext $ctx, string $fullurl, array $fetchdef): array
    {
