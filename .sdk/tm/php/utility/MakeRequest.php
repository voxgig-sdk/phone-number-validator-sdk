...
// PhoneNumberValidator SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PhoneNumberValidatorMakeRequest
{
    public static function call(PhoneNumberValidatorContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PhoneNumberValidatorResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PhoneNumberValidatorResponse($fetched);
        } else {
