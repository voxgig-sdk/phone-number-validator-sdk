...
|---|---|---|
| `ts/` | @voxgig-sdk/phone-number-validator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/phone-number-validator-sdk \
      --repository voxgig-sdk/phone-number-validator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/phone-number-validator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/phone-number-validator-sdk --id=<id>` removes it.
