...
This API validates phone numbers, providing details such as the local and international format.

Learn more about Phone Number Validator at [numlookupapi.com](https://numlookupapi.com).

This is an unofficial SDK for the Phone Number Validator public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — PhoneValidation — that you
...
// phonevalidation is the PhoneValidation entity, populated with mock data
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/phone-number-validator-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/phone-number-validator-sdk/tags) |
| Python | `voxgig-sdk-phone-number-validator` | publish pending — [install from git tag](https://github.com/voxgig-sdk/phone-number-validator-sdk/tags) |
| PHP | `voxgig-sdk/phone-number-validator` | publish pending — [install from git tag](https://github.com/voxgig-sdk/phone-number-validator-sdk/tags) |
...
| Ruby | `voxgig-sdk-phone-number-validator` | publish pending — [install from git tag](https://github.com/voxgig-sdk/phone-number-validator-sdk/tags) |
| Lua | `voxgig-sdk-phone-number-validator` | publish pending — [install from git tag](https://github.com/voxgig-sdk/phone-number-validator-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/phone-number-validator-sdk/go-cli` | `go install github.com/voxgig-sdk/phone-number-validator-sdk/go-cli/cmd/phone-number-validator@latest` |
| Go MCP server | `github.com/voxgig-sdk/phone-number-validator-sdk/go-mcp` | `go get github.com/voxgig-sdk/phone-number-validator-sdk/go-mcp@latest` |
...
// Load a specific phonevalidation (returns a PhoneValidation)
...
// Load a specific phonevalidation (returns the ENTITY; call data_get() for the record; throws on error)
$phonevalidation = $client->PhoneValidation()->load(["phone_number" => "example_phone_number"]);
...
phoneValidation, err := client.PhoneValidation(nil).Load(
    map[string]any{"phone_number": "example_phone_number"}, nil,
)
if err != nil {
    panic(err)
}
...
# Load a specific phonevalidation (returns the ENTITY; call data_get for the record)
phonevalidation = client.PhoneValidation.load({ "phone_number" => "example_phone_number" })
...
- Upstream API: [https://api.numlookupapi.com](https://api.numlookupapi.com)
