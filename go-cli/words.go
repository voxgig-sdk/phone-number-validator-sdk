...
func registerSDKWords(r *eng.Registry, client *sdk.PhoneNumberValidatorSDK) {
...
func runOp(client *sdk.PhoneNumberValidatorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
