// Command PhoneNumberValidator-cli is a CLI + REPL for the PhoneNumberValidator SDK,
...
const prompt = "phone-number-validator"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "phone_validation"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      PHONE_NUMBER_VALIDATOR_APIKEY (api key), PHONE_NUMBER_VALIDATOR_BASE (base url override)")
