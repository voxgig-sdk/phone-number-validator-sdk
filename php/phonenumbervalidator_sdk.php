...
class PhoneNumberValidatorSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = PhoneNumberValidatorHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = PhoneNumberValidatorHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!PhoneNumberValidatorFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, PhoneNumberValidatorFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return PhoneNumberValidatorUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = PhoneNumberValidatorHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = PhoneNumberValidatorHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = PhoneNumberValidatorHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new PhoneNumberValidatorError($op . "_allow",
                "PhoneNumberValidatorSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = PhoneNumberValidatorHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new PhoneNumberValidatorError("graphql_error",
                "PhoneNumberValidatorSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function PhoneValidation($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_phone_validation === null) {
                $this->_phone_validation = new PhoneValidationEntity($this, null);
            }
            return $this->_phone_validation;
        }
        return new PhoneValidationEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new PhoneNumberValidatorSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
