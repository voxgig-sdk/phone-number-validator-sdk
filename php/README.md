...
The PHP SDK for the PhoneNumberValidator API — an entity-oriented client using PHP conventions.
...
```php
[$result, $err] = $client->PhoneValidation()->load(["id" => "example_id"]);
...
[$result, $err] = $client->PhoneNumberValidator()->load(["id" => "test01"]);
