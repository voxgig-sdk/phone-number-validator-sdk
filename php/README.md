# PhoneNumberValidator PHP SDK

The PHP SDK for the PhoneNumberValidator API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->PhoneValidation(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->PhoneNumberValidator(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── phonenumbervalidator_sdk.php          -- Main SDK class
...
The main class (`phonenumbervalidator_sdk.php`) exports the SDK class
