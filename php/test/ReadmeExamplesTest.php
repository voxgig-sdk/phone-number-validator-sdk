...
// PhoneNumberValidator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PhoneNumberValidatorSDK::test)
...
{
    private const SDK_CLASS = 'PhoneNumberValidatorSDK';
    ...
    private const SDK_BASE = 'phonenumbervalidator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../phonenumbervalidator_sdk.php';
