...
// PhoneNumberValidator SDK utility: graphql
//
...
class PhoneNumberValidatorGraphql
{
    ...
    // equivalent.
    public static function body(PhoneNumberValidatorContext $ctx): mixed
    {
    ...
    public static function errors(PhoneNumberValidatorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
