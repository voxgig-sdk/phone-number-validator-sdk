...
// PhoneNumberValidator SDK utility: make_options

class PhoneNumberValidatorMakeOptions
{
    ...
    public static function call(PhoneNumberValidatorContext $ctx): array
    {
        ...
        //
        // `PhoneNumberValidatorSchema::optspec()` is built from the model:
        ...
        $optspec = PhoneNumberValidatorSchema::optspec();
