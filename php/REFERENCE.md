# PhoneNumberValidator PHP SDK Reference

Complete API reference for the PhoneNumberValidator PHP SDK.
...
#### `PhoneNumberValidatorSDK::test($testopts = null, $sdkopts = null)`
