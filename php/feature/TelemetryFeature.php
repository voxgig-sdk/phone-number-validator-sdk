...
// PhoneNumberValidator SDK telemetry feature
...
class PhoneNumberValidatorTelemetryFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    private function _close(PhoneNumberValidatorContext $ctx, bool $ok): void
    {
