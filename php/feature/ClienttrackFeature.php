...
// PhoneNumberValidator SDK clienttrack feature
...
class PhoneNumberValidatorClienttrackFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    public function PostConstruct(PhoneNumberValidatorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PhoneNumberValidator-SDK';
