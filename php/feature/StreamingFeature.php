...
// PhoneNumberValidator SDK streaming feature
...
class PhoneNumberValidatorStreamingFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    private function _iterate(PhoneNumberValidatorResult $result): \Generator
    {
    ...
    private function _streamable(PhoneNumberValidatorContext $ctx): bool
    {
