...
// PhoneNumberValidator SDK audit feature
...
class PhoneNumberValidatorAuditFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    private function _emit(PhoneNumberValidatorContext $ctx, string $outcome): void
    {
