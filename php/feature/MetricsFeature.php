...
// PhoneNumberValidator SDK metrics feature
...
class PhoneNumberValidatorMetricsFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    private function _record(PhoneNumberValidatorContext $ctx, bool $ok): void
    {
