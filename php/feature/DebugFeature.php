...
// PhoneNumberValidator SDK debug feature
...
class PhoneNumberValidatorDebugFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    private function _finish(PhoneNumberValidatorContext $ctx, bool $ok): void
    {
