...
// PhoneNumberValidator SDK idempotency feature
...
class PhoneNumberValidatorIdempotencyFeature extends PhoneNumberValidatorBaseFeature
{
    ...
    private function _mutating(PhoneNumberValidatorContext $ctx): bool
    {
