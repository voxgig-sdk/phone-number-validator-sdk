# PhoneNumberValidator Golang SDK Reference

Complete API reference for the PhoneNumberValidator Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *PhoneNumberValidatorSDK`
...
#### `PhoneValidation(data map[string]any) PhoneNumberValidatorEntity`
