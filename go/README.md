...
## Install
```bash
go get github.com/voxgig-sdk/phone-number-validator-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/phone-number-validator-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/phone-number-validator-sdk/go=../phone-number-validator-sdk/go
```
