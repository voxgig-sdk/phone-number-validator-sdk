...
type PhoneValidationEntity struct {
	name    string
	client  *core.PhoneNumberValidatorSDK
...
func NewPhoneValidationEntity(client *core.PhoneNumberValidatorSDK, entopts map[string]any) *PhoneValidationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PhoneValidationEntity) GetName() string { return e.name }
...
func (e *PhoneValidationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PhoneValidationEntity) Deleted() bool {
	return e.deleted
}


func (e *PhoneValidationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPhoneValidationEntity(e.client, opts)
}

func (e *PhoneValidationEntity) Data(args ...any) any {
...
func (e *PhoneValidationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PhoneValidation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PhoneValidationEntity) DataTyped(data ...PhoneValidation) PhoneValidation {
	if len(data) > 0 {
		return typedFrom[PhoneValidation](e.Data(asMap(data[0])))
	}
	return typedFrom[PhoneValidation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PhoneValidation (all fields
// optional at the wire level).
func (e *PhoneValidationEntity) MatchTyped(match ...PhoneValidation) PhoneValidation {
	if len(match) > 0 {
		return typedFrom[PhoneValidation](e.Match(asMap(match[0])))
	}
	return typedFrom[PhoneValidation](e.Match())
}
...
func (e *PhoneValidationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PhoneValidationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PhoneValidationLoadMatch and returns an PhoneValidation. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PhoneValidationEntity) LoadTyped(reqmatch PhoneValidationLoadMatch, ctrl map[string]any) (PhoneValidation, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PhoneValidation{}, err
	}
	return typedFrom[PhoneValidation](res), nil
}



func (e *PhoneValidationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PhoneValidationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PhoneValidationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PhoneValidationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PhoneValidationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
