...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("PHONENUMBERVALIDATOR_TEST_LIVE") == "TRUE" ||
		os.Getenv("PHONENUMBERVALIDATOR_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("PHONENUMBERVALIDATOR_TEST_EXPLAIN"); explain != "" {
