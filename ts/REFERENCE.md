# PhoneNumberValidator TypeScript SDK Reference

Complete API reference for the PhoneNumberValidator TypeScript SDK.
...
```ts
new PhoneNumberValidatorSDK(options?: object)
```
...
#### `PhoneNumberValidatorSDK.test(testopts?, sdkopts?)`
...
**Returns:** `PhoneNumberValidatorSDK` instance in test mode.


### Instance Methods

#### `PhoneValidation(data?: object)`

Create a new `PhoneValidation` entity instance.
...
**Returns:** `PhoneValidationEntity` instance.
...
Alias for `PhoneNumberValidatorSDK.test()`.
...
Return the parent `PhoneNumberValidatorSDK` instance.
