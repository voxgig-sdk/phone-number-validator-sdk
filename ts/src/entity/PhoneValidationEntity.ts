...
class PhoneValidationEntity extends PhoneNumberValidatorEntityBase<PhoneValidation> {
  ...
  make(this: PhoneValidationEntity) {
    return new PhoneValidationEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: PhoneValidationLoadMatch, ctrl?: Control): Promise<PhoneValidationEntity> {
