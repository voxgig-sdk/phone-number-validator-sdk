...
function envOverride(m) {
    if ('TRUE' === process.env.PHONE_NUMBER_VALIDATOR_TEST_LIVE ||
        'TRUE' === process.env.PHONE_NUMBER_VALIDATOR_TEST_OVERRIDE) {
    ...
    m.PHONE_NUMBER_VALIDATOR_TEST_EXPLAIN = process.env.PHONE_NUMBER_VALIDATOR_TEST_EXPLAIN || m.PHONE_NUMBER_VALIDATOR_TEST_EXPLAIN;
    return m;
}
