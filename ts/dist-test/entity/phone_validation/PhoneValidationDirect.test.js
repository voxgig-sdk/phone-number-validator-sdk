...
(0, node_test_1.describe)('PhoneValidationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PhoneNumberValidatorSDK({
    ...
    (0, node_test_1.test)('direct-load-phone_validation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-phone_validation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.PHONE_NUMBER_VALIDATOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PhoneNumberValidatorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.PHONE_NUMBER_VALIDATOR_APIKEY,
        }));
        let idmap = env['PHONE_NUMBER_VALIDATOR_TEST_PHONE_VALIDATION_ENTID'];
    ...
    const client = new __1.PhoneNumberValidatorSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PhoneValidationDirect.test.js.map