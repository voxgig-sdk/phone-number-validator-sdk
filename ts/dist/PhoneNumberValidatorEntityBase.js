...
exports.PhoneNumberValidatorEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends PhoneNumberValidatorEntityBase<Advice>`.
class PhoneNumberValidatorEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.PhoneNumberValidatorEntityBase = PhoneNumberValidatorEntityBase;
//# sourceMappingURL=PhoneNumberValidatorEntityBase.js.map