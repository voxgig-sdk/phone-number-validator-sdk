...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.PHONENUMBERVALIDATOR_TEST_LIVE ||
    'TRUE' === process.env.PHONENUMBERVALIDATOR_TEST_OVERRIDE
  ) {
  ...
  m.PHONENUMBERVALIDATOR_TEST_EXPLAIN = process.env.PHONENUMBERVALIDATOR_TEST_EXPLAIN || m.PHONENUMBERVALIDATOR_TEST_EXPLAIN
